...
{
    /**
     * Menampilkan daftar buku dengan DataTables.
     */
    ...
    /**
     * Menampilkan halaman form untuk membuat buku baru.
     */
    ...
    /**
     * Menampilkan halaman form untuk mengedit buku.
     */
    ...
    public function search(Request $request)
    {
        ...
        $books = Book::with('kategori')
            ...
            ->get();  // Mengambil semua hasil tanpa paginasi
